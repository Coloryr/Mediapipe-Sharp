...
public static class ImageFormatExtension
{
    ...
    public static int ByteDepth(this ImageFormat.Types.Format format)
    {
        return format switch
        {
            ...
            ImageFormat.Types.Format.Vec32F1 or ImageFormat.Types.Format.Vec32F2 or ImageFormat.Types.Format.Vec32F4 => 4,
    ...
    public static int ChannelSize(this ImageFormat.Types.Format format)
    {
        return format switch
        {
            ImageFormat.Types.Format.Srgb or ImageFormat.Types.Format.Srgba or ImageFormat.Types.Format.Sbgra => sizeof(byte),
            ...
            ImageFormat.Types.Format.Vec32F1 or ImageFormat.Types.Format.Vec32F2 or ImageFormat.Types.Format.Vec32F4 => sizeof(float),// sizeof float may be wrong since it's platform-dependent, but we assume that it's constant across all supported platforms.
