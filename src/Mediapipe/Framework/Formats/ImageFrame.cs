...
public class ImageFrame : MpResourceHandle
{
    ...
    public ImageFrame(ImageFormat.Types.Format format, int width, int height, int widthStep, nint pixelData, Deleter deleter) : base()
    {
        unsafe
        {
    ...
    public unsafe ImageFrame(ImageFormat.Types.Format format, int width, int height, int widthStep, byte[] pixelData, Deleter deleter) : base()
    {
