...
public static class PacketValidatorExtension
{
    ...
    public static void ValidateAsBool(this Packet<bool> packet) => packet.Validate();
    ...
    [Obsolete("Use Validate instead")]
    public static void ValidateAsBoolVector(this Packet<List<bool>> packet) => packet.Validate();
    ...
    [Obsolete("Use Validate instead")]
    public static void ValidateAsDouble(this Packet<double> packet) => packet.Validate();
    ...
    [Obsolete("Use Validate instead")]
    public static void ValidateAsFloat(this Packet<float> packet) => packet.Validate();
    ...
    [Obsolete("Use Validate instead")]
    public static void ValidateAsFloatArray(this Packet<float[]> packet) => packet.Validate();
    ...
    [Obsolete("Use Validate instead")]
    public static void ValidateAsFloatVector(this Packet<List<float>> packet) => packet.Validate();
    ...
    [Obsolete("Use Validate instead")]
    public static void ValidateAsGpuBuffer(this Packet<GpuBuffer> packet) => packet.Validate();
    ...
    [Obsolete("Use Validate instead")]
    public static void ValidateAsImage(this Packet<Image> packet) => packet.Validate();
    ...
    [Obsolete("Use Validate instead")]
    public static void ValidateAsImageFrame(this Packet<ImageFrame> packet) => packet.Validate();
    ...
    [Obsolete("Use Validate instead")]
    public static void ValidateAsInt(this Packet<int> packet) => packet.Validate();
    ...
    [Obsolete("Use Validate instead")]
    public static void ValidateAsProtoMessageLite<T>(this Packet<T> packet) where T : IMessage<T> => packet.Validate();
    ...
    [Obsolete("Use Validate instead")]
    public static void ValidateAsString(this Packet<string> packet) => packet.Validate();
}
